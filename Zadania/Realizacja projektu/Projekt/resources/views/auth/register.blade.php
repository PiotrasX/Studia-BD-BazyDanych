...
@include('shared.head', ['pageTitle' => 'Rejestracja nowego użytkownika'])
        ...
        <div class="container my-3">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <form method="POST" action="{{ route('auth.register.registerValidate') }}" class="needs-validation"
                        novalidate>
                        @csrf
                            ...
                            <select id="kraj" name="kraj"
                                ...
                                @foreach ($kraje as $kraj)
                                    <option value="{{ $kraj->nazwa }}"
                                        {{ old('kraj') === $kraj->nazwa ? 'selected' : '' }}>{{ $kraj->nazwa }}
                                    </option>
                                @endforeach
                            </select>
                            @if ($errors->has('kraj'))
